  ...
  return (
    <HelmetProvider>
      <Helmet>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Andada+Pro&family=Bebas+Neue&family=MonteCarlo&family=Roboto:wght@300&family=STIX+Two+Text&family=Style+Script&display=swap"
          rel="stylesheet"
        />
      </Helmet>
      <FontStyle>
        <TextBoard
          ...
          color={color}
        />
        {isEditing && <div>EditBtn</div>}
      </FontStyle>
    </HelmetProvider>
  );
};

const TextBoard = styled.div.attrs<TextBoardStyle>(({ fontSize, color }) => ({
  style: {
